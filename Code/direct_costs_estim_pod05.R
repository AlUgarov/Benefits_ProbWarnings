...
#Implied probability of a tornado in a 10-mile radius conditional on deterministic warning:
IP_det=(1-FAR)*(rel_area/warn_area)
...
#0.1=10% is the implied probability of tornado conditional on having a storm (see discussion on the distribution of probabilistic forecasts)
#0.1=\sum_i f_ip_i - sum of frequency-wighted predicted probabilities
